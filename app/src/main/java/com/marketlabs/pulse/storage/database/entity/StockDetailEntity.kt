...
/**
 * 💡 THOUGHT PROCESS:
 * The large, on-demand half of the preview/detail split — one row per symbol, written only
 ...
 * this codebase's existing "cache in Room, no TTL, shown until told to refresh" convention — a
 * re-opened symbol shows its last-fetched detail instantly while a
