...
/**
 * 💡 THOUGHT PROCESS:
 * `getStockPreviews()` is a single call to `GET /stocks/previews`, rather than a tracked-symbols
 * list plus N per-symbol fetches. `getStockDetail(symbol)` is fetched on demand, one symbol at a
