...
/**
 * Plain bulleted list from `considerations` -- the item count isn't assumed fixed. One
 * `PulseCard(DATA)`, header inside (`DataCardSectionHeader`), same as every other
 * list-style Detail section.
 */
@Composable
