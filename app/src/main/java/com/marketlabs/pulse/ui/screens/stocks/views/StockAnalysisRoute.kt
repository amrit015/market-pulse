 ...
 * screen in the app (one consistent loading treatment app-wide).
 *
...
fun StockAnalysisRoute(
    ...
    // The list's own technical-setup pill taps through to its `stock_setups` glossary definition
    // (as Stock Detail's own badge does) -- same
