...
/**
 * `PulseCard(DATA)` from `technical_indicators.returns` -- 1W/1M/3M/6M/YTD/1Y price returns,
 * Every window
 ...
 *
 * No 1D stat: the day's move already sits in the header price and the 1D chart, so this card starts
 * at one week.
 *
