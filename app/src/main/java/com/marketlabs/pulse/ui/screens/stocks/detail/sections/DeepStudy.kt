 ...
 *
 * Scenarios' merged-card shape: header in its own padded `Column`, a full-width divider, then
 * each subsection in its own padded block separated by a full-width divider (no trailing
 * `Spacer` after the last one).
 */
@Composable
...
private fun Subsection(title: String, text: String, modifier: Modifier = Modifier) {
    Column(modifier = modifier) {
        ...
        // Mean"/"What Would Need To Happen" labels use.
        Text(
            text = title,
