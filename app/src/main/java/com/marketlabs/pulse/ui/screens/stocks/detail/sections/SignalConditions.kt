 ...
 * (see `StockDetailViewModel`), cross-referenced here since `StockDetail` carries no day-over-day
 * delta of its own even though this box belongs on the Detail screen.
 */
@Composable
