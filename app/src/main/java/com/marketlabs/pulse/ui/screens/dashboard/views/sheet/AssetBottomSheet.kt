package com.marketlabs.pulse.ui.screens.dashboard.views.sheet
...
@Composable
fun MetricItem(label: String, value: String, paddingRight: androidx.compose.ui.unit.Dp) {
...
fun ColoredMetricItem(
    label: String,
    value: String,
    paddingRight: androidx.compose.ui.unit.Dp,
