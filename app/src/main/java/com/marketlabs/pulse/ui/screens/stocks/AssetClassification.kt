...
/**
 * Backed by the backend's `asset_type` field (STOCK | ETF | INDEX | CRYPTO | OTHER, added
 * 2026-09-14 to both `market_stocks/{symbol}` and its detail doc, defaulting server-side to
