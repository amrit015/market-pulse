 ...
 * row on narrower widths) rather than hand-coded fixed rows-of-3 -- where a row breaks isn't a
 * meaningful contract, just wherever 3 items happened to fit that viewport. No value gets
 * signal-colored here -- there's no defined rule for which fundamentals warrant it, and guessing
 * one risks implying a
